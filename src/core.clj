...
(defn nilf
  "Creates a new function from an old function that if passed nil as an
  argument, operates with some default argument instead. The last argument
  is the function to wrap. Similar to fnil but function comes last."
  [& more]
  (fn [& args]
    (let [f (last more)
...
;; TODO - get latest version from google group
(defn subseq2
  [coll start end]
...
;; somewhat unuseful as does not work on symbols
(defmacro japply
  [& args]
